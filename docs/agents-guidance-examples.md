...
- 指標の定義、対象期間、母集団、除外条件の判断に過去の知識が役立つ場合、関連するmemoryとexperienceを検索する。
...
- 対象機能、利用技術、既知の障害、設計判断に過去の知識が役立つ場合、関連するmemoryとexperienceを検索する。
...
- 症状、error message、対象component、直近の変更について過去の知見が診断に役立つ場合、関連するexperienceを検索する。
...
- 類似技術、過去のprototype、既知の制約が今回の比較や調査に役立つ場合、関連するmemoryとexperienceを検索する。
...
- 仕様の判断に過去の経緯が役立つ場合、関連する設計判断、利用者feedback、過去の変更理由を検索する。
