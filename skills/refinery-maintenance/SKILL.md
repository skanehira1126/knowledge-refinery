...
2. Review `refinery_list_projects` for stale names, summaries, discovery tags, or technologies. Propose factual metadata updates with the current revision; never add secrets, local absolute paths, or unsupported guesses.
